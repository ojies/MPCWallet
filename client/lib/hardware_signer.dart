...
// ---------------------------------------------------------------------------
// USB stub (placeholder for real hardware)
// ---------------------------------------------------------------------------

class UsbHardwareSigner implements HardwareSignerInterface {
  @override
  Future<void> connect() => throw UnimplementedError('USB signer not implemented');

  @override
  Future<void> disconnect() => throw UnimplementedError('USB signer not implemented');

  @override
  Future<DkgInitResult> dkgInit(int maxSigners, int minSigners) =>
      throw UnimplementedError('USB signer not implemented');
